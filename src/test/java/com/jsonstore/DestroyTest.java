...
public class DestroyTest extends InstrumentationTestCase {
	...
	public void testDestroyNotOpen() throws JSONStoreDestroyFailureException, JSONStoreTransactionFailureException {
	...
	public void testDoubleDestroy() throws JSONStoreException {
		JSONStore store = JSONStore.getInstance(getTestContext());
