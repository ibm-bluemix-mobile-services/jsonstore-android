...
public class CollectionAdvancedFindLikeTest extends InstrumentationTestCase {
	...
	public void testAdvancedFindLikeIntegerProveFuzzy() throws Throwable {
		JSONStoreCollection col = databaseSetup();
