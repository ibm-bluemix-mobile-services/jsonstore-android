...
public class JSONStoreCountException extends JSONStoreException {
	...
	public JSONStoreCountException(Throwable source) {
		super(source);
	}

	public JSONStoreCountException(String message, Throwable source) {
		super(message, source);
	}

	public JSONStoreCountException(String message) {
		super(message);
	}
