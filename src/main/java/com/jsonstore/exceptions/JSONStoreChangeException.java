...
public class JSONStoreChangeException extends JSONStoreException {
	...
	public JSONStoreChangeException(Throwable source) {
		super(source);
	}
	
	public JSONStoreChangeException(String message) {
		super(message);
	}

	public JSONStoreChangeException(String message, Throwable source) {
