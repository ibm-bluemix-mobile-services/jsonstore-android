...
public class JSONStoreTransactionDuringInitException extends JSONStoreException {
	...
	public JSONStoreTransactionDuringInitException(String message) {
		super(message);
	}

	public JSONStoreTransactionDuringInitException(String message, Throwable source) {
		super(message, source);
	}

	public JSONStoreTransactionDuringInitException(Throwable source) {
		super(source);
	}
